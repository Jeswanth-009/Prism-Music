  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<SearchBloc>().add(
        const UpdateFilterEvent(SearchFilter.songs),
      );
    });
  ...
  Widget _buildSearchHeader(
    ...
    return Column(
      ...
      children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Songs, artists, albums or playlists',
                      hintStyle: TextStyle(
        ...
        _ChipsWrap(items: genres.take(4).toList(), onTap: _applyQuickQuery),
        ...
        _ChipsWrap(items: vibes.take(4).toList(), onTap: _applyQuickQuery),
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            ShadToaster.of(
              context,
            ).show(const ShadToast(title: Text('Album view coming soon!')));
          },
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Artist', style: theme.textTheme.bodySmall),
                    ],
                  ),
                ),
                Icon(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            ShadToaster.of(
              context,
            ).show(const ShadToast(title: Text('Playlist view coming soon!')));
          },
          child: ShadCard(
            padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
            child: Row(
                ...
                ClipRRect(
                  ...
                  child: SizedBox(
                    ...
                    child: playlist.thumbnails?.medium != null
                        ...
                        : Container(
                            color: theme.colorScheme.surface,
                            child: const Icon(LucideIcons.listMusic, size: 20),
                          ),
                  ),
                ),
                const SizedBox(width: 14),
